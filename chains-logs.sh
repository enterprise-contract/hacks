...
# Use this script to stream logs from the Tekton Chains controller.
# It assumes the controller is part of the Deployment named tekton-chains-controller
# residing in the tekton-chains namespace.
